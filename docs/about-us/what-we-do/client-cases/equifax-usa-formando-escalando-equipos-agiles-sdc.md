...
En solo 2 semanas, 23people formó y desplegó el primero de los que se convertirían en múltiples equipos de desarrollo especializados para [Equifax USA](https://www.equifax.com/) en su [Santiago Development Center (SDC)](https://www.investchile.gob.cl/equifax-inaugurates-expansion-of-santiago-development-center-2/) en Chile. Lo que comenzó como un desafío de formar 2 equipos en tiempo récord trabajando en modo outsourcing, evolucionó hasta gestionar más de 50 profesionales distribuidos en 6 proyectos simultáneos para finales de 2019. La calidad del trabajo entregado llevó a Equifax a confiar a 23people la responsabilidad de proyectos previamente manejados por una consultora tecnológica internacional de primer nivel. Esta confianza se validó con resultados concretos: 13 profesionales fueron incorporados como empleados directos de Equifax mediante el modelo contract-to-hire, y la colaboración continúa fortaleciéndose hasta hoy, en 2025.

![Equifax USA](/_images/success-client-story-equifax-usa-1.png)

## Contexto del Cliente

Equifax, una de las tres principales agencias de información crediticia a nivel mundial, opera en más de 24 países y procesa datos de más de 820 millones de consumidores y 91 millones de empresas globalmente. En 2018, la compañía se encontraba en un momento importante de transformación digital, específicamente en la evolución de su plataforma de decisión crediticia [InterConnect](https://soluciones.equifax.cl/empresas/productos/interconnect/). Esta transformación se ejecutaba desde el Santiago Development Center (SDC) en Chile, un centro estratégico que [concentra cerca del 60% de los desarrollos digitales de Equifax a nivel global](https://blog.investchile.gob.cl/bloges/santiago-concentra-desarrollo-transformacion-digital-equifax-mundo), consolidando a Santiago como el hub tecnológico más importante de la compañía fuera de Estados Unidos.

![Equifax SDC](/_images/success-client-story-equifax-usa-2.png)
_Imagen: Inauguración del SDC de Equifax_
...
**Primero, la estrategia de reclutamiento flexible.**
...
**Segundo, equipos ágiles completos.**

Cada equipo se estructuró con 7 profesionales cuidadosamente balanceados:
...
**Tercero, programa de aceleración del Ramp-Up.**

Aprovechando el conocimiento previo de 23people en las soluciones de Equifax, se implementó un programa de 80 horas de capacitación intensiva que redujo el tiempo de productividad plena de 3 meses (cota inferior en la industria) a solo 6-8 semanas.

Todo lo anterior se implementó bajo los principios de [**transparencia, colaboración y mejora continua**](/principles) que caracterizan a 23people y que eran absolutamentes compatibles con la cultura de Equifax, asegurando que los equipos no solo cumplieran con los plazos, sino que también se integraran plenamente en la cultura de Equifax.

### Implementación y Ejecución

![Equifax SDC](/_images/success-client-story-equifax-usa-3.png)
_Imagen: Capacitación de los equipos_

**Fase 1: Arranque Acelerado (Julio 2018).**

El primer equipo ingresó a las oficinas de Equifax el 17 de julio, exactamente 2 semanas después del kickoff — cumpliendo el compromiso inicial. El equipo comenzó inmediatamente con iteraciones de 2 semanas, enfocándose en las funcionalidades de mayor prioridad para InterConnect Flex.
...
![Equifax SDC](/_images/success-client-story-equifax-usa-4.png)
_Imagen: Los dos primeros equipos para el SDC de Equifax_
...
Para más detalles sobre este proyecto, puedes visitar este enlace: [Equifax USA - Plataforma InterConnect](https://soluciones.equifax.cl/empresas/productos/interconnect/).
